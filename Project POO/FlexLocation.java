...
public class FlexLocation extends Location
{
    ...
    public void setCurrentLatitude(double cla) { this.currentLatitude = cla; }

    public void setCurrentLongitude(double clo) { this.currentLongitude = clo; }
    ...
    public FlexLocation clone() { return new FlexLocation(this); }
}
